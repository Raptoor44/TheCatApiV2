    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                // Pour plus d'informations sur la manière d'activer la confirmation de compte et la réinitialisation de mot de passe, veuillez
                // visiter https://go.microsoft.com/fwlink/?LinkID=532713
