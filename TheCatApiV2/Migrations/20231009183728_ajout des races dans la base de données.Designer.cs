...
namespace TheCatApiV2.Migrations
{
    ...
    [Migration("20231009183728_ajout des races dans la base de données")]
    partial class ajoutdesracesdanslabasededonnées
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheCatApiV2.DatabaseModels.BreedDatabaseModel", b =>
                {
                    ...
                    b.HasIndex("CatWeightId");

                    b.ToTable("BreedsDatabaseModel");
                });

            modelBuilder.Entity("TheCatApiV2.DatabaseModels.BreedDatabaseModel+Weight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheCatApiV2.DatabaseModels.BreedDatabaseModel", b =>
                {
                    b.HasOne("TheCatApiV2.DatabaseModels.BreedDatabaseModel+Weight", "CatWeight")
                        .WithMany()
                        .HasForeignKey("CatWeightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CatWeight");
                });
