...
{
    /// <inheritdoc />
    public partial class Premièremigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PicturesDatabaseModel",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UrlPicture = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NumberLiked = table.Column<int>(type: "int", nullable: false),
                    NumberBad = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PicturesDatabaseModel", x => x.Id);
                });
